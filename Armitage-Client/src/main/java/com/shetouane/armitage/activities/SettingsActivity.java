...
public class SettingsActivity extends Activity {
	...
	private EditText con_txtUsername, con_txtPassword, con_txtHost,
			con_txtPort, webserver_port;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prefs = this.getSharedPreferences("com.shetouane.armitage",
		...
		webserver_port.setText(Integer.toString(prefs.getInt("webserver_port",
				8080)));
	...
	private void saveSettings() {
		...
		editor.putString("connection_Username", con_txtUsername.getText()
				.toString());
		editor.putString("connection_Password", con_txtPassword.getText()
				.toString());
